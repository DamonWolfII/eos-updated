          ...
          <div className="container grid md:flex md:justify-around gap-8 px-4 md:px-6 md:items-center">
            <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4">
              <img
                ...
                height={128}
                src="/assets/members/Sarwesh.jpeg"
                style={{
                  aspectRatio: "128/128",
                  objectFit: "cover",
                }}
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 max-w-[500px]">
                    I'm a Computer Engineer with a passion for crafting innovative and user-friendly applications. I specialize in full-stack development, harnessing the latest technologies to deliver impactful and efficient solutions.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center md:items-end text-center md:text-right gap-4 ">
              <Button className="w-full md:w-auto" size="lg">
                <Link
                  href={
                    "https://drive.google.com/file/d/17bF0GH15Y5sfvq3DFqyNbHo4HC4vZ87h/view?usp=sharing"
                  }
                  target="_blank"
                >
                  View CV
              ...
              <div className="flex gap-4 ">
                <Link
                  ...
                  href="https://github.com/Sarwesh13"
                >
                  <GithubIcon className="h-6 w-6" />
                </Link>
                <Link
                  className="text-gray-400 hover:text-gray-50"
                  href="https://www.linkedin.com/in/sarwesh-kattel-111b26246//"
                >
                  <LinkedinIcon className="h-6 w-6" />
                </Link>
                <Link
                  className="text-gray-400 hover:text-gray-50"
                  href="https://www.instagram.com/sarweshkattel5/"
                >
            ...
            <div className="grid md:flex md:justify-center gap-8 md:w-full ">
              <div className="md:w-1/2">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                    I am a Computer Engineer with a robust background in full-stack development. My expertise spans a wide range of technologies, including React, Node.js, and MongoDB. I am dedicated to creating innovative and user-friendly applications that address real-world challenges.
                </p>
                <p className="text-gray-500 dark:text-gray-400 mt-4">
                    In my free time, I immerse myself in new technologies, keep abreast of the latest industry trends, and contribute to open-source projects. I am constantly seeking opportunities to learn and grow, and I am committed to delivering high-quality work to my clients and collaborators.
                </p>
